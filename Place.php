      ...
      public
		...
		function getAllPlaces(){
			...
			if ($this->db != null){
				...
				$error = array('error' => 'No place  found!');
				echo $error;
			}
		...
		public
		function getSinglePlace($nombreLugar) //Esta funcion me devuelve  el lugar determinado por el id ( todos los lugares es una lista, devuelve el de la posicion id) con respecto tabla LUGAREs
			{
			$resultArray = array();
		...
		public
		function getAllPlacesInRegion($nombreProvincia ){
			$resultArray = array();
		...
		public
		function getSinglePlaceInRegion($nombreProvincia, $nombreLugar){
			$resultArray = array();
